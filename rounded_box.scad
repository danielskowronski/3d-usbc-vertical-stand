// code in this module is taken straigh from `Customizable rounded box`
// by zapta is licensed under the Creative Commons - Public Domain Dedication license.
// original model page: https://www.thingiverse.com/thing:551484/files
